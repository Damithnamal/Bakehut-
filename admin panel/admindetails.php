...
$table = '';
$query = "SELECT* FROM ladmin_login1";
...
if($result_set){
    ...
    {
        $table .='<tr>';
        $table .='<td>'. $record['admin_id'] . '</td>';
        $table .='<td>'. $record['admin_name'] . '</td>';
...
<section>
<main>
    <table class="admindetails" align="center">
        <thead>
            <tr>
            <th>Admin id</th>
            <th>Admin Name</th>
...
<div class="footer">
		<div class="inner-footer">
			...
			<div class="footer-items">
                ...
                <a href="#" class="logo">Thusara Ren<span>.</span></a>
